...
from random import randint as rand_randint, uniform as rand_uniform, choice as rand_choice, shuffle
from . import GTree
from . import Util
...
def G1DListInitializatorOrder(genome, **args):
    """

    Order initializer for like the Traveling Salesman Problem

    """
    range_min = genome.getParam("rangemin", 1)
    range_max = genome.getParam("rangemax", 10)

    genome.genomeList = list(range(range_min, range_max + 1))
